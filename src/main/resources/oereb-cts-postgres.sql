...
CREATE TABLE agi_oereb_cts_v1.checkresult (
  ...
  ,processingtimesecs decimal(7,3) NOT NULL
...
CREATE TABLE agi_oereb_cts_v1.proberesult (
  ...
  ,testsuitetime timestamp NOT NULL
  ,serviceendpoint varchar(1023) NOT NULL
  ,request varchar(1023) NOT NULL
  ,resultfilelocation text NOT NULL
  ,classname text NOT NULL
  ,success boolean NOT NULL
  ,starttime timestamp NOT NULL
  ,endtime timestamp NOT NULL
...
CREATE UNIQUE INDEX T_ILI2DB_MODEL_iliversion_modelName_key ON agi_oereb_cts_v1.T_ILI2DB_MODEL (iliversion,modelName)
;
...
VERSION "2023-08-19" =
  ...
  STRUCTURE Result (ABSTRACT) =
    ...
    endTime : MANDATORY FORMAT INTERLIS.XMLDateTime "2000-01-01T00:00:00.000" .. "2100-12-31T23:59:59.999";
...
END SO_AGI_OEREB_CTS_20230819.','2023-08-26 18:28:22.996');
...
INSERT INTO agi_oereb_cts_v1.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('SO_AGI_OEREB_CTS_20230819.Result.endTime','ili2db.ili.attrCardinalityMin','1');
